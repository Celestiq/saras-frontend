...
"[project]/app/payment/success/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function PaymentProcessor() {
    ...
    const [message, setMessage] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('Processing your payment...');
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PaymentProcessor.useEffect": ()=>{
            const processPayment = {
                "PaymentProcessor.useEffect.processPayment": async ()=>{
                    ...
                    if (isCreditPurchase && orderId) {
                        ...
                        try {
                            ...
                            const captureResponse = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["captureCreditPurchase"])(orderId);
                            setStatus('success');
                            setMessage("Payment successful! ".concat(captureResponse.credits_added, " credits have been added to your account."));
                            // For credit purchases, we don't need to fetch order details
                            return;
                        } catch (error) {
                            setStatus('error');
                            const errorMessage = error instanceof Error ? error.message : 'Unknown error occurred';
                            setMessage("Credit purchase failed: ".concat(errorMessage));
                            return;
                        }
                    } else if (paymentType === 'subscription' && subscriptionId) {
                        try {
                            setMessage('Verifying your subscription...');
                            const subscriptionResponse = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["verifyPayPalSubscription"])(subscriptionId);
                            setStatus('success');
                            ...
                            setStatus('error');
                            const errorMessage = error instanceof Error ? error.message : 'Unknown error occurred';
                            setMessage("Subscription verification failed: ".concat(errorMessage));
                            return;
                        }
                    } else if (paymentType === 'order' && orderId) {
                        try {
                            setMessage('Finalizing your payment...');
                            const captureResponse = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["capturePayPalOrder"])(orderId);
                            setStatus('success');
                            ...
                            setStatus('error');
                            const errorMessage = error instanceof Error ? error.message : 'Unknown error occurred';
                            setMessage("Payment capture failed: ".concat(errorMessage));
                            return;
                        }
                    ...
                    if (finalOrderId) {
                        try {
                            ...
                            const orderData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getOrderById"])(finalOrderId);
                            setOrder(orderData);
                        } catch (error) {
            ...
            }["PaymentProcessor.useEffect.processPayment"];
            processPayment();
        }
    }["PaymentProcessor.useEffect"], [
        searchParams,
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$badge$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Badge"], {
                                        className: "".concat(getStatusColor(order.status), " flex items-center gap-1"),
                                        children: [
                            ...
                            order.payment_method && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                        className: "text-sm flex items-center gap-1",
                                        children: [
                                            order.payment_method.includes('paypal') ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$credit$2d$card$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__CreditCard$3e$__["CreditCard"], {
                                                className: "w-4 h-4"
                                            }, void 0, false, {
                                                fileName: "[project]/app/payment/success/page.tsx",
                                                lineNumber: 224,
                                            ...
                                            order.payment_method === 'paypal' ? 'PayPal Subscription' : order.payment_method === 'paypal_onetime' ? 'PayPal One-time' : order.payment_method === 'credits' ? 'Credits' : order.payment_method
                                        ]
                                    }, void 0, true, {
                                        fileName: "[project]/app/payment/success/page.tsx",
                                        lineNumber: 222,
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: [
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                                ...
                                                                children: item.subscription ? 'Subscription' : 'One-time purchase'
                                                            }, void 0, false, {
                                                                fileName: "[project]/app/payment/success/page.tsx",
                                                                lineNumber: 245,
                                                                columnNumber: 45
...
_s(PaymentProcessor, "fo3gNNlDYq67ujf78H6pErs7PDU=", false, function() {
    return [
...
function PaymentSuccessPage() {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Suspense"], {
            ...
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(PaymentProcessor, {}, void 0, false, {
                fileName: "[project]/app/payment/success/page.tsx",
                lineNumber: 292,
                columnNumber: 17
            }, this)
...
var _c, _c1;
__turbopack_context__.k.register(_c, "PaymentProcessor");
...
//# sourceMappingURL=_3cdbac79._.js.map